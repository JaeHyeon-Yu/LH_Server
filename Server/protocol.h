...
struct CS_UPDATE_MOVE_STATE {
	char size;
	char type;
	short state;
};

struct SC_UPDATE_MOVE_STATE {
	char size;
	char type;
	short oid;
	short state;
